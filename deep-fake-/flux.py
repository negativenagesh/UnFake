import torch
from diffusers import FLUXImg2ImgPipeline  # Assuming this pipeline exists
...
def process_images_to_deepfake_flux(input_folder, output_folder):
    ...
    # Load the pre-trained FLUX.1 [schnell] model
    ...
    # Define the updated prompt and parameters
    prompt = (
        ...
        if filename.lower().endswith(supported_extensions):
            try:
                ...
                for face_location in face_locations:
                    ...
                    # Ensure face image is reasonable size for the model (512x512 works well with FLUX.1)
